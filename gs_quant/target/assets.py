...
class HedgeFundParameters(Base):
    ...
    first_close_date: Optional[datetime.date] = field(default=None, metadata=field_metadata)
    final_close_date: Optional[datetime.date] = field(default=None, metadata=field_metadata)
    ...
    targeted_num_of_investments: Optional[NumberRange] = field(default=None, metadata=field_metadata)
    ...
    vintage_name: Optional[str] = field(default=None, metadata=field_metadata)
    vintage: Optional[int] = field(default=None, metadata=field_metadata)
    ...
    open_to_portable_alpha: Optional[bool] = field(default=None, metadata=field_metadata)
    name: Optional[str] = field(default=None, metadata=name_metadata)
...
class ShareClassParameters(Base):
    ...
    carried_interest_waterfall: Optional[str] = field(default=None, metadata=field_metadata)
    preferred_return: Optional[float] = field(default=None, metadata=field_metadata)
    catch_up: Optional[str] = field(default=None, metadata=field_metadata)
    commitment_period: Optional[float] = field(default=None, metadata=field_metadata)
    investment_deployment_period: Optional[float] = field(default=None, metadata=field_metadata)
    harvest_period: Optional[float] = field(default=None, metadata=field_metadata)
    extension_rights: Optional[str] = field(default=None, metadata=field_metadata)
...
class AssetGetRequestPathSchema(Base):
    ...
    asset_classifications_digital_asset_class: Optional[tuple[str, ...]] = field(default=None, metadata=field_metadata)
    ...
    first_close_date: Optional[tuple[Union[Op, datetime.date], ...]] = field(default=None, metadata=field_metadata)
    ...
    asset_classifications_digital_asset_sector: Optional[tuple[str, ...]] = field(default=None, metadata=field_metadata)
    ...
    asset_classifications_underliers_asset_class: Optional[tuple[str, ...]] = field(default=None, metadata=field_metadata)
    ...
    vintage_name: Optional[tuple[str, ...]] = field(default=None, metadata=field_metadata)
    ...
    final_close_date: Optional[tuple[Union[Op, datetime.date], ...]] = field(default=None, metadata=field_metadata)
