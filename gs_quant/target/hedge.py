...
@dataclass_json(letter_case=LetterCase.CAMEL)
@dataclass(unsafe_hash=True, repr=False)
class HedgeObjectiveRiskParameters(Base):
    weight: float = field(default=None, metadata=field_metadata)
    factor_weight: float = field(default=None, metadata=field_metadata)
    specific_weight: float = field(default=None, metadata=field_metadata)
    risk_type: Optional[str] = field(init=False, default='Variance', metadata=field_metadata)
    name: Optional[str] = field(default=None, metadata=name_metadata)
...
@dataclass_json(letter_case=LetterCase.CAMEL)
@dataclass(unsafe_hash=True, repr=False)
class HedgeObjectiveParameters(Base):
    parameters: HedgeObjectiveRiskParameters = field(default=None, metadata=field_metadata)
    name: Optional[str] = field(default=None, metadata=name_metadata)
...
class FactorHedgeParameters(Base):
    ...
    target_net_notional: Optional[float] = field(default=None, metadata=field_metadata)
    hedge_notional: Optional[float] = field(default=None, metadata=field_metadata)
    ...
    hedge_objective_parameters: Optional[HedgeObjectiveParameters] = field(default=None, metadata=field_metadata)
